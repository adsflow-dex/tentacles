  ...
  return [
    {
      ...
      icon: <Marketing className={cn('h-24 w-24 fill-white')} />,
    },
    {
      ...
      icon: <Content className={cn('h-24 w-24 fill-white')} />,
    },
    {
      ...
      icon: <Presentation className={cn('h-24 w-24 fill-white')} />,
    },
    {
      ...
      icon: <Offices className={cn('h-24 w-24 fill-white')} />,
    },
    {
      ...
      icon: <Growth className={cn('h-24 w-24 fill-white')} />,
    },
  ];
};
